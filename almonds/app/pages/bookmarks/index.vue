...
const bookmarks = [
  { title: "Vue.js Documentation", url: "https://vuejs.org", tag: "Development", date: "Feb 15, 2026" },
  { title: "Tailwind CSS Cheatsheet", url: "https://tailwindcss.com", tag: "Design", date: "Feb 14, 2026" },
  { title: "Nuxt 4 Migration Guide", url: "https://nuxt.com", tag: "Development", date: "Feb 12, 2026" },
  { title: "Figma Community Resources", url: "https://figma.com", tag: "Design", date: "Feb 10, 2026" },
];
  ...
  <NuxtLayout name="default">
    ...
    <template #side_content>
      ...
      <div class="flex flex-col gap-2">
        ...
        <div class="flex items-center gap-3 py-2 px-3 rounded-lg text-gray-600 dark:text-gray-400 text-sm hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
