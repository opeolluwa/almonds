use entities::playlists::{ActiveModel, Model};
...
use crate::{
    entities, errors::app_error::AppError, types::playlist::CreatePlaylistInput,
...
impl CreatePlaylist {
    ...
    ) -> async_graphql::Result<entities::playlists::Model, AppError> {
