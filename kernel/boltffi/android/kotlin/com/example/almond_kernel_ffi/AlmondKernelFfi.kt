...
package com.example.almond_kernel_ffi
...
enum class ItemType(val value: Int) {
    ...
    companion object {
        ...
        fun fromWireTag(tag: Int): ItemType = entries.getOrElse(tag) {
            throw FfiException(-1, "Unknown ItemType wire tag: $tag")
        }

        fun decode(reader: WireReader): ItemType = fromWireTag(reader.readI32())
    }
...
enum class Priority(val value: Int) {
    ...
    companion object {
        ...
        fun fromWireTag(tag: Int): Priority = entries.getOrElse(tag) {
            throw FfiException(-1, "Unknown Priority wire tag: $tag")
        }

        fun decode(reader: WireReader): Priority = fromWireTag(reader.readI32())
    }
...
enum class Tag(val value: Int) {
    ...
    companion object {
        ...
        fun fromWireTag(tag: Int): Tag = entries.getOrElse(tag) {
            throw FfiException(-1, "Unknown Tag wire tag: $tag")
        }

        fun decode(reader: WireReader): Tag = fromWireTag(reader.readI32())
    }
...
data class Model(
    ...
    val url: String,
    val tag: Tag,
    val createdAt: DateTimeWithTimeZone,
    val updatedAt: DateTimeWithTimeZone
) {
    companion object {
    ...
    fun wireEncodeTo(wire: WireWriter) {
        ...
        wire.writeI64(createdAt)
        wire.writeI64(updatedAt)
    }
}
...
private object Native {
    init {
        val preferredLibrary = "almond_kernel_ffi_jni"
        val fallbackLibrary = "almond_kernel_ffi"
