use chrono::Utc;
use entities::ollama_conversation_response::ActiveModel;
...
pub struct CreateOllamaConversationResponseInput {
    pub history_id: Uuid,
...
impl Into<ActiveModel> for CreateOllamaConversationResponseInput {
